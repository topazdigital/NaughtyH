          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem', flexWrap: 'wrap', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              ...
              <button onClick={triggerAutoMessages} disabled={triggering} style={{
                padding: '0.3rem 0.75rem', background: '#6B1FA2', color: '#fff',
            ...
            <div style={{ display: 'flex', gap: '0.2rem', padding: '0.4rem 0.75rem', borderBottom: '1px solid #1e293b', overflowX: 'auto' }}>
              {ACT_TABS.map(t => (
                <button key={t.key} onClick={() => setActFilter(t.key)} style={{
                  ...
                  background: actFilter === t.key ? '#6B1FA2' : '#1e293b',
            ...
            <div style={{ maxHeight: '420px', overflowY: 'auto' }}>
              {actLoading ? (
                <div style={{ display: 'flex', justifyContent: 'center', padding: '2rem' }}>
                  <div style={{ width: '1.25rem', height: '1.25rem', border: '2px solid #6B1FA2', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
                </div>
              ) : activity.length === 0 ? (
