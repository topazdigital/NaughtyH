...
const S = {
  ...
  btn: (color = "#6B1FA2") => ({ padding: "0.4rem 0.875rem", background: color, color: "#fff", border: "none", borderRadius: "0.5rem", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", gap: "0.3rem" } as React.CSSProperties),
  input: {
    width: "100%",
    background: "#1e293b",
        ...
        <div className={`admin-chat-list ${mobileShowChat ? 'admin-chat-list--hidden' : ''}`} style={{ ...S.card, display: "flex", flexDirection: "column", maxHeight: 600, overflowY: "auto" }}>
          ...
          <div style={{ display: "flex", gap: 0, borderBottom: "1px solid #1e293b", flexShrink: 0 }}>
            {([
              ...
              { key: "needs_reply",  label: "🔴 Reply",    color: "#6B1FA2" },
          ...
          {(() => {
            ...
            if (loading) return (
              <div style={{ display: "flex", justifyContent: "center", padding: "3rem" }}>
                <div style={{ width: "1.5rem", height: "1.5rem", border: "2px solid #6B1FA2", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
              </div>
            )
