      ...
      <aside style={{
        ...
        <div style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #e2e8f0' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
            <div style={{ width: '2rem', height: '2rem', borderRadius: '0.625rem', background: 'linear-gradient(135deg,#6B1FA2,#9340d6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.9rem', boxShadow: '0 3px 8px rgba(107,31,162,0.35)' }}>❤️</div>
            <div>
              <p style={{ color: '#1e293b', fontWeight: 800, fontSize: '0.78rem' }}>NaughtyHaughty</p>
              <p style={{ color: '#6B1FA2', fontSize: '0.65rem', fontWeight: 700 }}>Admin Panel</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '0.625rem 0.75rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.625rem', padding: '0.5rem 0.625rem', background: '#fef2f2', borderRadius: '0.625rem', border: '1px solid #fecaca' }}>
            <div style={{ width: '1.875rem', height: '1.875rem', borderRadius: '50%', background: '#6B1FA2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 800, fontSize: '0.8rem', flexShrink: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ color: '#6B1FA2', fontSize: '0.62rem', fontWeight: 700, letterSpacing: '0.05em' }}>ADMINISTRATOR</p>
            </div>
          </div>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem' }}>
            {MENU.map(m => (
              <button key={m.key} onClick={() => { setTab(m.key); setSidebarOpen(false) }} style={{
                ...
                background: tab === m.key ? 'linear-gradient(135deg,#6B1FA2,#9340d6)' : 'transparent',
                ...
                {m.key === 'fake-chat' && chatUnread > 0 && (
                  <span style={{
                    background: tab === m.key ? 'rgba(255,255,255,0.9)' : '#6B1FA2',
                    color: tab === m.key ? '#6B1FA2' : '#fff',
